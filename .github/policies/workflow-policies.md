...
**Postcondition** (harness-architect): The task has `harness-ready` label, the harness compiles (`python -m py_compile src/docline/__init__.py`), and all tests fail with expected failure markers.
...
**Precondition**: `python -m py_compile src/docline/__init__.py` exits 0 AND `pytest` exits non-zero with expected failure markers in the output for every test function.
...
|---------|--------------|------------------|----------------------------|
| 1.0.0   | 2026-08-31     | Initial registry | Generated by autoharness   |
| 1.1.0   | 2026-08-31     | Added P-006      | Plan hardening gate enforcement |
| 1.2.0   | 2026-08-31     | Added P-007      | Backlogit archive integrity after shipment |
| 1.3.0   | 2026-08-31     | Added P-008      | Markdown conformance enforcement |
| 1.4.0   | 2026-08-31     | Added P-009      | Merge-commit-only policy |
| 1.5.0   | 2026-08-31     | Added P-010      | Agent role boundary (Stage/Ship/Orchestrator) |
| 1.6.0   | 2026-08-31     | Added P-011      | Branch-before-mutation (Ship) |
| 1.7.0   | 2026-08-31     | Added P-012      | Tool availability and declared degradation |
| 1.8.0   | 2026-08-31     | Added P-013      | Agent tier hierarchy and escalation |
| 1.9.0   | 2026-08-31     | Added P-014      | Local review readiness merge gate — preserves explicit approval and advisory shadow-review migration |
| 1.10.0  | 2026-08-31     | Added P-015      | Single-artifact shipment closure — prohibits cascade shipment-ship, requires verify-after-each invariant + git-revert-on-cascade |
| 1.11.0  | 2026-08-31     | Added P-016      | No parallel branch/worktree execution, with only explicit Stage spike/research worktrees exempt |
| 1.12.0  | 2026-08-31     | Added P-017      | Dark factory autonomy contract — bounded autonomous execution, local-review authority, and audited merge approval |
