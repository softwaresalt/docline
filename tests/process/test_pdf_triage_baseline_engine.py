...
def test_get_markitdown_silences_noisy_pdfminer_loggers() -> None:
    ...
    # Reset both loggers and the singleton so we exercise the install path.
    for name in ("pdfminer.pdffont", "pdfminer.pdfinterp"):
        logging.getLogger(name).setLevel(logging.NOTSET)
    pdf_triage._MARKITDOWN_INSTANCE = None
